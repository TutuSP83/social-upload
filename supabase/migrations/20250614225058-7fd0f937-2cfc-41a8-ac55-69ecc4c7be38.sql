...
-- 1. Política SELECT: Usuários autenticados podem ver seus próprios avatars
...
-- 2. Política INSERT: Usuários autenticados podem fazer upload de avatars
...
-- 3. Política UPDATE: Usuários autenticados podem atualizar seus próprios avatars
...
-- 4. Política DELETE: Usuários autenticados podem deletar seus próprios avatars
