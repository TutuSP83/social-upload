...
interface BulkMoveModalProps {
  ...
  onMove: (fileIds: string[], folderId: string | null) => Promise<void>;
...
export const BulkMoveModal = ({ 
  ...
  const handleMove = async () => {
    ...
    try {
      ...
      await onMove(fileIds, selectedFolderId);
      onClose();
    } catch (error) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>
            Mover {selectedFiles.length} arquivo(s)
          </DialogTitle>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button 
            onClick={handleMove}
            disabled={selectedFolderId === currentFolderId || moving}
          >
